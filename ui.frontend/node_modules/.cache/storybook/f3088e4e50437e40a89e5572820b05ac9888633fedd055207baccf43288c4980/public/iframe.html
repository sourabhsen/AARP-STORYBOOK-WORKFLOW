<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Webpack App</title><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="prefetch" href="./sb-common-assets/nunito-sans-regular.woff2" as="font" type="font/woff2" crossorigin><link rel="prefetch" href="./sb-common-assets/nunito-sans-italic.woff2" as="font" type="font/woff2" crossorigin><link rel="prefetch" href="./sb-common-assets/nunito-sans-bold.woff2" as="font" type="font/woff2" crossorigin><link rel="prefetch" href="./sb-common-assets/nunito-sans-bold-italic.woff2" as="font" type="font/woff2" crossorigin><link rel="stylesheet" href="./sb-common-assets/fonts.css"><base target="_parent"><style>/* While we aren't showing the main block yet, but still preparing, we want everything the user
    ...
    console.warn('unable to connect to top frame for connecting dev tools');
  }</script><link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600|Asar&display=swap" rel="stylesheet"><link href="http://localhost:4502/etc.clientlibs/wknd/clientlibs/clientlib-grid.css" rel="stylesheet"><link href="http://localhost:4502/etc.clientlibs/core/wcm/components/accordion/v1/accordion/clientlibs/site.css" rel="stylesheet"><link href="http://localhost:4502/etc.clientlibs/core/wcm/components/tabs/v1/tabs/clientlibs/site.css" rel="stylesheet"><link href="http://localhost:4502/etc.clientlibs/core/wcm/components/carousel/v1/carousel/clientlibs/site.css" rel="stylesheet"><link href="http://localhost:4502/etc.clientlibs/core/wcm/components/image/v2/image/clientlibs/site.css" rel="stylesheet"><link href="http://localhost:4502/etc.clientlibs/core/wcm/components/search/v1/search/clientlibs/site.css" rel="stylesheet"><link href="http://localhost:4502/etc.clientlibs/core-components-examples/clientlibs/clientlib-base.min.css" rel="stylesheet"><script type="text/javascript" src="http://localhost:4502/etc.clientlibs/core/wcm/components/accordion/v1/accordion/clientlibs/site.js"></script><script type="text/javascript" src="http://localhost:4502/etc.clientlibs/core/wcm/components/tabs/v1/tabs/clientlibs/site.js"></script><script type="text/javascript" src="http://localhost:4502/etc.clientlibs/core/wcm/components/carousel/v1/carousel/clientlibs/site.js"></script><script type="text/javascript" src="http://localhost:4502/etc.clientlibs/core/wcm/components/image/v2/image/clientlibs/site.js"></script><script type="text/javascript" src="http://localhost:4502/etc.clientlibs/core/wcm/components/search/v1/search/clientlibs/site.js"></script><style>#storybook-root[hidden],
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./stories","files":"**/*.stories.@(js|jsx|mjs|ts|tsx)","importPathMatcher":"^\\.[\\\\/](?:stories(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|mjs|ts|tsx))$"}];
      ...
      import './vendors-node_modules_storybook_addon-essentials_dist_actions_preview_mjs-node_modules_storybo-1edde1.iframe.bundle.js';
